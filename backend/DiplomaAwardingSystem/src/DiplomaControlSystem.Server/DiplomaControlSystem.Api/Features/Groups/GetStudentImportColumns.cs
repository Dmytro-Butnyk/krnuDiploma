...
public static class GetStudentImportColumns
{
    internal static class Endpoint
    {
        public static void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet("/groups/student-import/columns", Handle)
                .WithSummary("Gets accepted student import table columns")
        ...
        {
            return TypedResults.Ok(CreateResponse(StudentImportColumnDefinitions.All));
        }
