...
using DocumentGenerationSubsystem.Api.Infrastructure.Scenarios;
...
public sealed class DynamicDocumentEngine(
    ...
    ScenarioHelperRunner scenarioHelperRunner)
    : IScopedService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var computedContextResult = await scenarioHelperRunner.BuildComputedContextAsync(
            config,
            parameters,
            dataContext,
            cancellationToken);
